...
@interface SDMODataPropertyInfo : NSObject <NSCoding> {
	...
	NSUInteger						m_SemanticTypes;//for example:    ;TYPE=work,pref,...
	//Label
	NSString*						m_Label;
	...
	//Display orders>>
	NSInteger						m_ListDisplayOrder;
	NSInteger							m_DetailDisplayOrder;
...
@property (nonatomic, assign, getter=getMaxLength, setter=setMaxLength:) NSInteger maxLength;
@property (nonatomic, assign, getter=getSemantic, setter=setSemantic:) enum TEN_PROPERTY_SEMANTICS semantic;
@property (nonatomic, assign, getter=getSemanticTypes, setter=setSemanticTypes:) NSUInteger semanticTypes;
...
@property (nonatomic, assign, getter=getListDisplayOrder, setter=setListDisplayOrder:) NSInteger listDisplayOrder;
@property (nonatomic, assign, getter=getDetailDisplayOrder, setter=setDetailDisplayOrder:) NSInteger detailDisplayOrder;
