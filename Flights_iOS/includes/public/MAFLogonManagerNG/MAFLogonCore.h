 ...
 */
@property (nonatomic, retain, readonly) MAFApplicationSettings* applicationSettings;
...
/**
 Delete an object from the secure store with the given key.
 @param aKey the key for which the object will be stored.
 @param anError should contain the address of an NSError*. Will contain the address of an error on return or nil on success.
 */
...
/**
 Set the default values for different parameters.
 The structure should be the same as the MAFLogonOperationContextDefaultValues.plist.
 In order to use the correct structure, first get the default values using the proper method, and make the changes on the returned object.
 @param defaultValues : defaultValues to be set
 */
