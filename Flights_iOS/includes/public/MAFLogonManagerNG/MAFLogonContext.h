...
/**
 Authentication Types with configurations
 */
@property (nonatomic, copy) NSMutableArray* registrationContextAuth;
...
/**
 Is set if Mobile Place configuration was successfully downloaded
 */
@property (assign) BOOL hasConfigurationDataFromMobilePlace;
