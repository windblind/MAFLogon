...
/**
 Property for signing whether credentials are set for downloading certificate / seed data from Afaria.
 */
@property (nonatomic, assign) bool isAfariaCredentialsProvided;
