...
@interface Request : NSOperation <Requesting, NSCopying, NSCoding> {
	 ...
	 */
	id <CacheDelegate> m_DownloadCache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
	
	/**
	 * The cache policy used for this request. See CacheDelegate.h for possible values.
     *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
	 */
	ECachePolicy m_CachePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
	
	/**
	 * The cache storage policy that will be used for this request - See CacheDelegate.h for possible values
     *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
	 */
	ECacheStoragePolicy m_CacheStoragePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
	
	/**
	 * Will be true when the response was pulled from the cache rather than downloaded
     *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
	 */
	BOOL m_DidUseCachedResponse DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
