 ...
 */
+ (id)requestWithURL:(NSURL *)newURL usingCache:(id <CacheDelegate>)cache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");

/**
 * Convenience constructor with url, cache and cache policy.
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 */
+ (id)requestWithURL:(NSURL *)newURL usingCache:(id <CacheDelegate>)cache andCachePolicy:(ECachePolicy)policy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
 ...
 *  @param cache object
 */
+ (void)setDefaultCache:(id <CacheDelegate>)cache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
 ...
 */
+ (id <CacheDelegate>)defaultCache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
 ...
 */
@property (assign) id <CacheDelegate> downloadCache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 */
@property (assign) ECachePolicy cachePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 */
@property (assign) ECacheStoragePolicy cacheStoragePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 */
