...
#pragma mark - OperationContext keys
...
/**
 Challenge code, used for onboarding porta;
 */
#define keyMAFLogonOperationContextChallengeCode @"keyMAFLogonOperationContextChallengeCode"

/**
 Indicates type of registration. Possible values manual, certificate
 */
#define keyMAFLogonOperationContextUserCreationPolicy @"keyMAFLogonOperationContextUserCreationPolicy"
...
#pragma mark - RegistrationContextConfig keys

/**
 Authentication configurations are transmitted as an array, as it may be necessary in the future to combine configurations
 */
#define keyMAFLogonRegistrationContextAuthConfigs @"keyMAFLogonRegistrationContextAuthConfigs"

/**
 Authentication Types
 */
#define keyMAFLogonRegistrationContextAuthType @"keyMAFLogonRegistrationContextAuthType"
