...
// The related properties and APIs have not been removed in order to prevent build issues
 ...
 *
 */
+ (id)requestWithURL:(NSURL *)newURL usingCache:(id <SDMCacheDelegate>)cache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 ...
 *
 */
+ (id)requestWithURL:(NSURL *)newURL usingCache:(id <SDMCacheDelegate>)cache andCachePolicy:(CachePolicy)policy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
...
/**
 *  Sets default download cache, which will be used by all requests
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 *  @param cache cache object
 * @see SDMDownloadCache
 */
+ (void)setDefaultCache:(id <SDMCacheDelegate>)cache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 *  Returns the download cache instance (if any)
 *
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 *  @remark By default there is no download cache; however, clients can enable the download cache or set a custom one
 *
 *  @return download cache instance or nil if none has been set
 *  @see setDefaultCache:, requestWithURL:usingCache: etc. APIs
 */
+ (id <SDMCacheDelegate>)defaultCache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
...
@property (assign, readonly) BOOL didUseCachedResponse DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons"); ///< always returns NO
...
/**
 *  Allows setting and retrieving the download cache
 *  @remark the download cache is disabled by default
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 * @see setDefaultCache:, SDMDownloadCache
 */
@property (assign) id <SDMCacheDelegate> downloadCache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 */
@property (assign) CachePolicy cachePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 */
@property (assign) CacheStoragePolicy cacheStoragePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
/**
 *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
 */
@property (assign) NSTimeInterval secondsToCache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
