...
//	NSString* m_CompressedPostBodyFilePath;
	 ...
	 */
	id <SDMCacheDelegate> m_DownloadCache DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
	
	/**
	 * The cache policy that will be used for this request - See CacheDelegate.h for possible values
     *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
	 */
	CachePolicy m_CachePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
	
	/**
	 * The cache storage policy that will be used for this request - See CacheDelegate.h for possible values
     *  @warning Note that download cache functionality has been disabled due to security reasons; the related properties and APIs have not been removed in order to prevent build issues
	 */
	CacheStoragePolicy m_CacheStoragePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
