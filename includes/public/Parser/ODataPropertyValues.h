...
-(NSDate*) getDateValue __attribute__((deprecated("Please use -(NSDateComponents*) getDateComponents; instead which also contains time zone information")));

/** 
 *Gets the date time componenets ( date and time zone information )
 */
