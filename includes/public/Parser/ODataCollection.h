...
@interface ODataCollection : NSObject <NSCoding> {
	NSInteger								m_ContentVersion;		//default 1
	...
	NSInteger						m_DisplayOrder;			//if the collection is a top level collection then this is the relative display order
...
@property (nonatomic, assign, getter=getContentVersion, setter=setContentVersion:) NSInteger contentVersion;
...
@property (nonatomic, assign, getter=getDisplayOrder, setter=setDisplayOrder:) NSInteger displayOrder;
